  ...
  scheduleDate() {
    window.open(
      "mailto:someonesomewhere@gmail.com?subject=Schedule a date&body=" +
        `I would like to schedule a date with ${topMatch.username}.`,
      "_blank"
    );
  }
          ...
          <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div className="row mb-7">
              <div className="col-12 d-flex justify-content-center align-items-center">
                <img src={purpleAppLogo} width="40px" alt="Matchmake Me Logo" />
                <h2 className="text-brand text-primary d-inline mt-2 ml-2">
                  Matchmake Me
                </h2>
              </div>
            </div>
            <Link to="/matches" className="btn btn-link mb-7" role="button">
              <img
                src={leftChevron}
                width="20px"
                className="mr-1 mb-1"
            ...
            <div className="col-12 col-md-11 col-lg-10 col-xl-9">
              ...
              >
                <img src={heartIcon} width="20px" className="mr-2" alt="" />
                Schedule a date
              </button>
            </div>
            <div className="row">
            ...
            <ul className="mb-8">
              <li>
                <p className="mb-3">
                  Living a health lifestyle is important to both of you.
                </p>
              </li>
              <li>
                <p className="mb-3">Both of you are Christian/Protestant.</p>
              </li>
              <li>
                <p className="mb-3">
              ...
              <li>
                <p className="mb-3">
                  Racial injustice is an important issue to both of you.
                </p>
              </li>
              <li>
                <p className="mb-3">Both of you have one or more dogs.</p>
              </li>
              <li>
              ...
              <li>
                <p className="mb-3">
                  You both enjoy the following: traveling internationally,
            ...
            <div className="row mb-8">
              <div className="col-6 col-md-7 col-lg-8 col-xl-8">
                <p>
                  How important is it for you to climb the ladder at your job
                  and get promotions?
                </p>
              </div>
              <div className="col-6 col-md-5 col-lg-4 col-xl-4">
            ...
            <div className="row mb-8">
              <div className="col-6 col-md-7 col-lg-8 col-xl-8">
                <p>Which political topics are least important to you?</p>
              </div>
              <div className="col-6 col-md-5 col-lg-4 col-xl-4">
